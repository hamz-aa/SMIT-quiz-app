...
app.use(
  "/admin",
  swaggerUi.serveFiles(superAdminDocuments),
  swaggerUi.setup(superAdminDocuments)
);
app.use(
  "/student",
  swaggerUi.serveFiles(studentDocuments),
  swaggerUi.setup(studentDocuments)
);
